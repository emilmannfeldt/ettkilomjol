...
let existingFoods = [];
let existingTags = [];
let tagsFrom = ["Citron", "Burgare", "Italiensk", "Bönor"];
let tagsTo = ["asdfaafffsdf", "Afrikansk", "Japansk", "Burgare"];
let foodsFrom = ["Olivolja", "Avokado", "Salt", "Pastasås"];
let foodsTo = ["asdfff", "Aubergine", "Peppar", "Pastavatten"];
